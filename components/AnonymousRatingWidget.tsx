...
export default function AnonymousRatingWidget({ cityId }: { cityId: string }) {
  ...
  function handleSubmit() {
    ...
    console.log("Anonymous rating:", { cityId, score, style });
    setSubmitted(true);
  }
  ...
  if (submitted) {
    return (
      <div className="bg-green-50 border border-green-200 rounded-xl p-4 text-center">
        ...
        <p className="text-green-600 text-sm mt-1">Your score helps shape the traveler rating.</p>
      </div>
    );
  }
  ...
  return (
    <div className="bg-gray-50 border border-gray-200 rounded-xl p-4">
      ...
      <p className="text-xs text-gray-500 mb-4">
        Anonymous ratings help shape the traveler score but are shown separately from member reviews.
      </p>
